...
//controllers
import { signup, login, refreshAccessToken, logoutUser } from "../controller/auth-controller.js";
...
import { verifyJwtToken } from "../controller/jwt-controller.js";
...
route.post("/logout", verifyJwtToken, logoutUser);
